...
PINNED API VERSION: same version string as Isaac Science (``v4.4.0`` as of
the 2026-08-29 rediscovery) at time of writing, pinned independently since
this is a separate deployment of the platform. Same failure mode /
rediscovery method as documented in ``isaac_science.py``.
...
# Rediscovered 2026-08-29 (was "v4.2.7", started 502ing — same platform
# as isaac_science.py, version confirmed independently on this domain).
API_VERSION = "v4.4.0"
